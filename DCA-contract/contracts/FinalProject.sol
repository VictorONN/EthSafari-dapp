...
/// @title This contract seeks to dollar cost average eth purchases before the Merge
//Implementation is borrowed from https://docs.uniswap.org/protocol/guides/swaps/single-swaps 
...
/// @notice This function purchases WETH from Uniswap. 
/// @dev The owner calls this function once a day
...
///@notice Users call this function to deposit funds into our contract
...
/// @notice Withdraw only after the merge
